    ...
    <form method="POST" action="consultation.php">
      ...
      <div class="form-group">
        ...
        <select name="Pet_id" id="Pet_id" style="width: 92.5em;" class="form-select form-select-sm">
          <?php
          $sql = "select p.Pet_id, p.Name,p.Cust_id,c.First_name from pet p INNER JOIN customer c ON p.Cust_id = c.Cust_id";
          $results = mysqli_query($conn, $sql);
      ...
      <div class="form-group">
        ...
        <input type="number" max="10000" min="1" style="width: 80.9em;" step="1" id="Price" name="Price" class="form-control">
      </div>
