...
<link href="./transaction/style.css" rel="stylesheet" type="text/css"></head>
<body>
<h1 align="center">View Cart</h1>
<div class="cart-view-table-back">
<form method="POST" action="transac_update.php">
<table width="150%"  cellpadding="6" cellspacing="2"><thead><tr>
    <th>Name</th><th>Price</th><th>Remove</th></tr></thead>
  <tbody>
  <?php
//echo "<pre>";
//print_r($_SESSION);
...
?>
    ...
    <tr><td colspan="5"><a href="transac.php" class="button">Add More Items</a>
